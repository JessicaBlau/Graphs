...
class DGraphTest {
    ...
    @Test
    void removeNode() {
        assertNull(g.removeNode(8));
        //System.out.println(g.getV().toString());
        int tmpEdgeSize = g.edgeSize();
        int tmpNodeDataSize = g.nodeSize();
        g.removeNode(2);
        assertEquals(tmpNodeDataSize - 1, g.nodeSize());
        assertEquals(tmpEdgeSize - 2, g.edgeSize());
    ...
    void removeEdge() {
        ...
        int tmpEdgeSize = g.edgeSize();
        g.removeEdge(0, 5);
        assertEquals(tmpEdgeSize - 1, g.edgeSize());
